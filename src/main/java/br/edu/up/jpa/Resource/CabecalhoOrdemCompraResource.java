...
public class CabecalhoOrdemCompraResource {
	...
	@PostMapping("/")
	public CabecalhoOrdemCompra postCabecalhoOrdemCompra(
			@RequestBody @Valid CabecalhoOrdemCompra cabecalhoOrdemCompra) {
		return repository.save(cabecalhoOrdemCompra);
	}

	// @PostMapping("/efetuarCompra")
	// public CabecalhoOrdemCompra postEfetuarCompra(@RequestBody DadosCompra
	// dadosCompra) {
